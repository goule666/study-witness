 ...
 * @description 中国的变压器的适配器实现类
 **/
public class ChinaVoltHandlerAdapter implements VoltHandlerAdapter {
    /**
    ...
    public boolean supports(Object voltHandler) {
        return voltHandler instanceof ChinaVoltHandler;
    }
    ...
    public Integer handler(Integer volt, Object voltHandler) {
        return ((ChinaVoltHandler) voltHandler).convert(volt);
    }
}
